...
public class MatterCrystalArmor extends ArmorItem {
    public MatterCrystalArmor(EquipmentSlotType slot, Properties builderIn) {
        super(LVArmorTier.MatterCrystalTier, slot, builderIn);
    }
    ...
    public void appendHoverText(ItemStack p_77624_1_, @Nullable World p_77624_2_, List<ITextComponent> p_77624_3_, ITooltipFlag p_77624_4_) {
        p_77624_3_.add(new TranslationTextComponent("msg."+ModId+".matter_crystal_armor1"));
        p_77624_3_.add(new TranslationTextComponent("msg."+ModId+".matter_crystal_armor2"));
