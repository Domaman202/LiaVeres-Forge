...
public class Registration {
    ...
    public static final RegistryObject<MatterCrystalArmor> MATTER_CRYSTAL_HELMET = ITEMS.register("matter_crystal_helmet", () -> new MatterCrystalArmor(EquipmentSlot.HEAD, new Item.Properties().fireResistant().tab(LIAVERES_ALL)));
    public static final RegistryObject<MatterCrystalArmor> MATTER_CRYSTAL_CHESTPLATE = ITEMS.register("matter_crystal_chestplate", () -> new MatterCrystalArmor(EquipmentSlot.CHEST, new Item.Properties().fireResistant().tab(LIAVERES_ALL)));
    public static final RegistryObject<MatterCrystalArmor> MATTER_CRYSTAL_LEGS = ITEMS.register("matter_crystal_leggings", () -> new MatterCrystalArmor(EquipmentSlot.LEGS, new Item.Properties().fireResistant().tab(LIAVERES_ALL)));
    public static final RegistryObject<MatterCrystalArmor> MATTER_CRYSTAL_BOOTS = ITEMS.register("matter_crystal_boots", () -> new MatterCrystalArmor(EquipmentSlot.FEET, new Item.Properties().fireResistant().tab(LIAVERES_ALL)));
    public static final RegistryObject<MatterArmor> MATTER_HELMET = ITEMS.register("matter_helmet", () -> new MatterArmor(EquipmentSlot.HEAD, new Item.Properties().fireResistant().tab(LIAVERES_ALL)));
    public static final RegistryObject<MatterArmor> MATTER_CHESTPLATE = ITEMS.register("matter_chestplate", () -> new MatterArmor(EquipmentSlot.CHEST, new Item.Properties().fireResistant().tab(LIAVERES_ALL)));
    public static final RegistryObject<MatterArmor> MATTER_LEGS = ITEMS.register("matter_leggings", () -> new MatterArmor(EquipmentSlot.LEGS, new Item.Properties().fireResistant().tab(LIAVERES_ALL)));
    public static final RegistryObject<MatterArmor> MATTER_BOOTS = ITEMS.register("matter_boots", () -> new MatterArmor(EquipmentSlot.FEET, new Item.Properties().fireResistant().tab(LIAVERES_ALL)));
