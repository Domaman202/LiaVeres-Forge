...
public class GoldenNetheriteArmor extends ArmorItem {
    public GoldenNetheriteArmor(EquipmentSlot pSlot) {
        super(LVArmorMaterial.GOLDEN_NETHERITE, pSlot, new Properties().rarity(Rarity.valueOf("LEGENDARY")).fireResistant().tab(ModSetup.CLASSIC_TAB));
    }
    ...
    public void onArmorTick(ItemStack stack, Level world, Player player) {
        ...
        boolean isFullGoldenNetheriteArmor =
                head.getItem() == Registration.GOLDEN_NETHERITE_HELMET.get() &&
                chest.getItem() == Registration.GOLDEN_NETHERITE_CHESTPLATE.get() &&
                legs.getItem() == Registration.GOLDEN_NETHERITE_LEGS.get() &&
                feet.getItem() == Registration.GOLDEN_NETHERITE_BOOTS.get();
