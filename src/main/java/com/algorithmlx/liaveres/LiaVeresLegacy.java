...
import com.algorithmlx.liaveres.setup.proxy.Common;
...
public class LiaVeresLegacy {
    ...
    public static final String CLIENT = "com.algorithmlx.liaveres.setup.proxy.Common";
    public static final String SERVER = "com.algorithmlx.liaveres.setup.proxy.Common";
